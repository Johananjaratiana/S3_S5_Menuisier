            ...
            <li class="nav-item">
                ...
                <div class="collapse mesure-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-unite">
                          <span class="menu-title">Unité</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-volume">
            ...
            <li class="nav-item">
                ...
                <div class="collapse materiel-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-materiel">
                          <span class="menu-title">Matériel</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-stock">
                          <span class="menu-title">Entrée matériels en stock</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        
                        <h6 class="collapse-header">Monétaire</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-prix-materiel">
            ...
            <li class="nav-item">
                ...
                <div class="collapse style-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <h6 class="collapse-header">Insertion</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-style">
                          <span class="menu-title">Style</span>
                          <i class="mdi mdi-home menu-icon"></i>
                        </a>
                        
                        <h6 class="collapse-header">Contrainte matériel</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-style-materiel">
            ...
            <li class="nav-item">
                ...
                <div class="collapse meuble-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-categorie">
                          <span class="menu-title">Catégorie</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-produit">
                          <span class="menu-title">Produits</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-meuble">
                          <span class="menu-title">Meubles</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        
                        <h6 class="collapse-header">Composition</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-quantite-outils">
                          <span class="menu-title">Meubles et quantité matériel</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>

                        <h6 class="collapse-header">Prix meubles</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-prix-meuble">
            ...
            <li class="nav-item">
                ...
                <div class="collapse fabrication-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <h6 class="collapse-header">Insertions</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-mode-fabrication">
                          <span class="menu-title">Mode de fabrication</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-fabrication">
            ...
            <li class="nav-item">
                ...
                <div id="employe-collapse" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <h6 class="collapse-header">Insertions</h6>  
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-employee">
                          <span class="menu-title">Employées</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-type-employee">
                          <span class="menu-title">Type employée</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a> 

                        <h6 class="collapse-header">Grade</h6>  
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-grade-employee">
                          <span class="menu-title">Grade existant</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-grade-params">
                          <span class="menu-title">Paramètres</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        
                        <h6 class="collapse-header">Affectation</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=crud-employement">
            ...
            <li class="nav-item">
                ...
                <div class="collapse filtre-collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">                    
                    <div class="bg-gradient-info collapse-inner rounded my-collapsed">
                        ...
                        <h6 class="collapse-header">Monétaire</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=benefice-meuble">
                          <span class="menu-title">Filtre bénéfice apporté (/meubles)</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=filtre-prix">
                          <span class="menu-title">Filtre par prix de fabrication</span>
                          <%-- <i class="mdi mdi-contacts menu-icon"></i> --%>
                        </a>

                        <h6 class="collapse-header">Fabrication</h6>
                        <a class="my-nav-link collapse-item" href="/Johan_S3/Controller?action=formule-materiel-request">
