...
<%
	...
	List<V_stock_materiel_restante> stock_restante = (List<V_stock_materiel_restante>) request.getAttribute("stock_restante");
%>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
					<h4 class="" id="my-title">Entrée de stock matériel(s)</h4>
					<form class="forms-sample" action="/Johan_S3/Controller" method="post">
						<input type="hidden" name="action" value="stock-materiel-insert">
						...
						<div id="crud-stock-materiel">
							...
							<thead>
								...
								<th>
									...
									<button class="sort btn" style="color: green;" data-sort="reste">
										<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
											<path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293z"/>
										</svg>
									</button>
							...
							<tbody class="list">
								<% for(V_stock_materiel_restante sr : stock_restante) { %>
									<tr>
										<td class="materiel"><%= sr.getNom_materiel()%></td>
										<td class="reste money-number"><%= sr.getReste()%></td>
										<td class="unite"><%= sr.getNom_unite()%></td>
									</tr>
								<% } %>
							</tbody>
							<tfoot>
