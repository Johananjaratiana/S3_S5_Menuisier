...
<%
	...
	List<V_prix_materiel> prix_materiels = (List<V_prix_materiel>) request.getAttribute("prix_materiels");
%>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
					<h4 class="card-title" id="my-title">Prix des matériels</h4>
					<form class="forms-sample" action="/Johan_S3/Controller" method="post">
						<input type="hidden" name="action" value="prix-materiel-insert">
						<div class="form-group">
							<label for="project">Matériels</label>
						...
						<div class="form-group">
							<label for="ip">Prix</label>
							<input type="text" name="prix_unitaire" class="form-control" id="ip" placeholder="...">
						</div>
						<br/>
				...
				<div class="card">
					<div class="card-body" style="min-height: 520px;">
						...
						<div id="crud-produit">
							...
							<tbody class="list">
								<% for(V_prix_materiel pm : prix_materiels) { %>
									<tr>
										<td class="produit"><%= pm.getNom_materiel()%></td>
										<td class="categorie"><%= pm.getPrix_unitaire()%></td>
									</tr>
								<% } %>
							</tbody>
							<tfoot>
