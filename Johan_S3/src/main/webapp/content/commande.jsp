...
<%
	...
	List<V_commande> commandes = (List<V_commande>) request.getAttribute("commandes");
%>
	...
	<div class="row">
		<div class="col-md-6">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
					<h4 class="card-title" id="my-title">Entrée de commande</h4>
					<form class="forms-sample" action="/Johan_S3/Controller" method="post">
						<input type="hidden" name="action" value="commande-insert">
			...
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body" style="min-height: 520px;">
						<h4 class="card-title" id="my-title">Liste commandes</h4>
