				...
				<div class="card">
					...
					<h4 class="card-title" id="my-title">Prix des matériels</h4>
						<form class="form-horizontal" action="/Johan_S3/Controller" method="post">
							<input type="hidden" name="action" value="prix-meuble-insert">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-12 control-label">Prix</label>
								<div class="col-sm-10">
												<input class= "form-control" name="prix_vente"/>
								</div>
							</div>
							<br/>
