	...
	<div class="row">
		<div class="col-md-6">
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body">
					<h4 class="card-title" id="my-title">Paramétrage de fabrication</h4>
					<form class="form-horizontal" action="/Johan_S3/Controller" method="post">
						<input type="hidden" name="action" value="duree-fabrication-insert">
			...
			<div class="col-12 grid-margin">
				<div class="card">
					<div class="card-body" style="min-height: 520px;">
						<h4 class="card-title" id="my-title">Durée par employée pendant la fab.</h4>
							...
							<tbody class="list">
								<% for(V_duree_fabrication df : duree_fabrications) { %>
									<tr>
										...
										<td class="nombre"><%= df.getNombre()%></td>
										<td class="duree"><%= df.getDuree()%></td>
									</tr>
								<% } %>
							</tbody>
							<tfoot>
