<%-- 
    Document   : index
    Created on : 16 nov. 2023, 11:14:24
    Author     : johan
--%>
        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
          <div class="h-32 md:h-auto md:w-1/2">
            <img
              ...
              src="assets/images/logo/login-office.jpeg"
              alt="Office"
            />
            <img
              aria-hidden="true"
          ...
          <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
            <form action="/Johan_S3/Login" method="post" class="w-full">
              <h1
              ...
              <label class="block text-sm">
                ...
                <input
                  ...
                  name="email"
                  type="email"
                  value="tsaramiranaandriambelo@gmail.com"
                />
              </label>
              <label class="block mt-4 text-sm">
                ...
                <!-- Error -->
                <jsp:include page="templates/error-label.jsp" />
                <!-- Error -->
