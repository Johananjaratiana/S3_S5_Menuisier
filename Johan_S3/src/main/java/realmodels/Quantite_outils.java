...
public class Quantite_outils extends models.Quantite_outils {
    ...
    public static void setDefaultDataToView(Connection connection, HttpServletRequest request) throws Exception {
        try {
            ...
            models.V_quantite_outils vqo = new models.V_quantite_outils();

            List<models.V_quantite_outils> quantite_outils = vqo.GetAll("", false, connection);
    ...
    public static void Save(Connection connection, HttpServletRequest request) {
        try{
            ...
            Quantite_outils quantite_outil = Johan_Servlet.constructByFormView(Quantite_outils.class, request, isChildClass);
            
            if(quantite_outil.getQuantite() == null)throw new Exception("Veuillez insérez une quantité.");
            ...
            if (list.size() == 0) throw new Exception("On ne peut pas utiliser cette matériels séléctionner dans ce meuble.");
    ...
    public static void AvoidDuplicateMateriel(Connection connection, Quantite_outils quantite_outils)throws Exception{
        try{
