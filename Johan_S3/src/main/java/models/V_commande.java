  ...
  public class V_commande {
	...
	public void setDate_(Object date_) { this.date_ = date_; }
      ...
      public List<V_commande> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_commande> objectDao = new Johan_DaoSQL<V_commande>(V_commande.class);
