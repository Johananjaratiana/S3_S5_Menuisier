  ...
  public class V_benefice_meuble {
  	@J_Column(name = "id")
	private Integer id;
	...
	public void setBenefice(Float benefice) { this.benefice = benefice; }
      ...
      public List<V_benefice_meuble> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_benefice_meuble> objectDao = new Johan_DaoSQL<V_benefice_meuble>(V_benefice_meuble.class);
