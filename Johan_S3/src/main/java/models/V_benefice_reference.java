  ...
  public class V_benefice_reference {
  	@J_Column(name = "id")
	private Integer id;
	...
	public Float getBenefice() { return benefice; }
	...
	public void setBenefice(Float benefice) { this.benefice = benefice; }

      public List<V_benefice_reference> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_benefice_reference> objectDao = new Johan_DaoSQL<V_benefice_reference>(V_benefice_reference.class);
