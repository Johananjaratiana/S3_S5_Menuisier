  ...
  public class V_meuble {
	...
	public void setNom_produit(String nom_produit) { this.nom_produit = nom_produit; }
      ...
      public List<V_meuble> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_meuble> objectDao = new Johan_DaoSQL<V_meuble>(V_meuble.class);
