  ...
  public class V_formule_materiel {
	...
	public void setQuantite(Float quantite) { this.quantite = quantite; }
      ...
      public List<V_formule_materiel> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_formule_materiel> objectDao = new Johan_DaoSQL<V_formule_materiel>(V_formule_materiel.class);
