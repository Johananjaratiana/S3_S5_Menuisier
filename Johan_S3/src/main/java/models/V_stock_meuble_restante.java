  ...
  public class V_stock_meuble_restante {
	...
	public void setQuantite(Integer quantite) { this.quantite = quantite; }
      ...
      public List<V_stock_meuble_restante> GetAll(String addRequest, Boolean isChildClass, Connection connection) throws Exception{
      	try{
      		Johan_DaoSQL<V_stock_meuble_restante> objectDao = new Johan_DaoSQL<V_stock_meuble_restante>(V_stock_meuble_restante.class);
