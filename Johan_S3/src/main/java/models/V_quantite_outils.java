  ...
  public class V_quantite_outils {
	...
	@J_Column(name = "status_reference")
	private Integer status_reference;
	...
	public Integer getStatus_reference() { return status_reference; }
	...
	public void setStatus_reference(Integer status_reference) { this.status_reference = status_reference; }
